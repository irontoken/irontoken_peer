...
public:
    ...
    {
        // starktoken: the coin stake transaction is marked with the first output empty
    ...
    */
    ...
    bool GetCoinAge(CTxDB& txdb, uint64& nCoinAge) const;  // starktoken: get transaction coin age
...
public:
    ...
    // starktoken: block signature - signed by coin base txout[0]'s owner
    ...
    // starktoken: two types of block: proof-of-work or proof-of-stake
    ...
    // starktoken: get max transaction timestamp
    ...
    bool AcceptBlock();
    bool GetCoinAge(uint64& nCoinAge) const; // starktoken: calculate total coin age spent in block
    bool SignBlock(const CKeyStore& keystore);
    bool CheckBlockSignature() const;
    unsigned int GetStakeEntropyBit() const; // starktoken: entropy bit for stake modifier if chosen by modifier
...
public:
    ...
    unsigned int nFile;
    unsigned int nBlockPos;
    CBigNum bnChainTrust; // starktoken: trust score of block chain
    int nHeight;
    int64 nMint;
    int64 nMoneySupply;

    unsigned int nFlags;  // starktoken: block index flags
    enum  
    {
